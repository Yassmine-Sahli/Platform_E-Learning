...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Design / Figma</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/figma.pdf"
                    ...
                    <iframe 
                            src="https://www.youtube.com/embed/IOVFRMuPeVQ"
                            frameborder="0"
                    ...
                    <div class="container">
                        <h1>Discover Your ability in Figma</h1>
                        <div class="instructions">
                        Instructions: Answer each question. At the end, your total score will help indicate how well you know figma.
                        </div>
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What is Figma mainly used for?</h2>
                                <button onclick="selectAnswer(this, 1, 0)">a) UI/UX Design</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Video Editing</button>
                                <button onclick="selectAnswer(this, 0, 0)">c) Backend Development</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Data Analysis</button>
                            </div>
                            <div class="question">
                                <h2>2. Which file type does Figma primarily use?</h2>
                                <button onclick="selectAnswer(this, 0, 1)">a) .figma</button>
                                <button onclick="selectAnswer(this, 0, 1)">b) .psd</button>
                                <button onclick="selectAnswer(this, 1, 1)">c) Cloud-based (no file extension)</button>
                                <button onclick="selectAnswer(this, 0, 1)">d) .xd</button>
                            </div>
                            <div class="question">
                                <h2>3. Can Figma be used collaboratively in real-time?</h2>
                                <button onclick="selectAnswer(this, 1, 2)">a) Yes</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) Only with plugins</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) No</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) Only when exported</button>
                            </div>
                            <div class="question">
                                <h2>4. What is a “Frame” in Figma?</h2>
                                <button onclick="selectAnswer(this, 1, 3)">a) A container used to group elements and define layouts</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) A video layer</button>
                                <button onclick="selectAnswer(this, 0, 3)">c) A shortcut key</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) A plugin</button>
                            </div>
                            <div class="question">
                                <h2>5. Which tool allows you to replicate spacing and layout in Figma?</h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) Pen tool</button>
                                <button onclick="selectAnswer(this, 1, 4)">b) Auto Layout</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) Slicer</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) Vector networks</button>
                            </div>
                            <div class="question">
                                <h2>6. What is the purpose of Figma Components?</h2>
                                <button onclick="selectAnswer(this, 1, 5)">a) Reusable design elements that maintain consistency</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) Audio tracks</button>
                                <button onclick="selectAnswer(this, 0, 5)">c) Export presets</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) Color filters</button>
                            </div>
                            <div class="question">
                                <h2>7. Which panel in Figma allows you to inspect CSS code?</h2>
                                <button onclick="selectAnswer(this, 1, 6)">a) Inspect Panel</button>
                                <button onclick="selectAnswer(this, 0, 6)">b) Design Panel</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) Plugins Panel</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) Code Compiler</button>
                            </div>
                            <div class="question">
                                <h2>8. How can you share a Figma file with others?</h2>
                                <button onclick="selectAnswer(this, 1, 7)">a) By sharing a link</button>
                                <button onclick="selectAnswer(this, 0, 7)">b) Through a USB drive</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) With email attachments only</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) You can't share files</button>
                            </div>
                            <div class="question">
                                <h2>9. Which of the following best describes a “Prototype” in Figma?</h2>
                                <button onclick="selectAnswer(this, 1, 8)">a) A clickable flow that simulates the user experience</button>
                                <button onclick="selectAnswer(this, 0, 8)">b) A backup of your file</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) A code file</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) A design element</button>
                            </div>
                            <div class="question">
                                <h2>10. What is the purpose of “Variants” in Figma?</h2>
                                <button onclick="selectAnswer(this, 1, 9)">a) To combine multiple component states (like hover, active)</button>
                                <button onclick="selectAnswer(this, 0, 9)">b) To animate transitions</button>
                                <button onclick="selectAnswer(this, 0, 9)">c) To export to different formats</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) To install plugins</button>
                            </div>
                        </div>
