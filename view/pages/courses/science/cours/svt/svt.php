...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Science / Science Theory</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/svt.pdf"
                    ...
                    <iframe 
                            src="https://www.youtube.com/embed/3tisOnOkwzo"
                            frameborder="0"
                    ...
                    <div class="container">
                    <h1>Discover Your Ability in Science Theory</h1>
                    <div class="instructions">
                    Instructions: Answer each question. At the end, your total score will help indicate how well you know Science.
                    </div>
                    <div id="quiz">
                        <div class="question">
                            <h2>1. What is the main function of mitochondria in a cell?</h2>
                            <button onclick="selectAnswer(this, 1, 0)">a) Energy production</button>
                            <button onclick="selectAnswer(this, 0, 0)">b) Protein synthesis</button>
                            <button onclick="selectAnswer(this, 0, 0)">c) Genetic material storage</button>
                            <button onclick="selectAnswer(this, 0, 0)">d) Waste removal</button>
                        </div>
                        
                        <div class="question">
                            <h2>2. What is the process of photosynthesis primarily responsible for?</h2>
                            <button onclick="selectAnswer(this, 0, 1)">a) Producing oxygen</button>
                            <button onclick="selectAnswer(this, 1, 1)">b) Producing glucose</button>
                            <button onclick="selectAnswer(this, 0, 1)">c) Decomposing waste</button>
                            <button onclick="selectAnswer(this, 0, 1)">d) Breaking down sugars</button>
                        </div>
                        
                        <div class="question">
                            <h2>3. What is DNA's primary role in living organisms?</h2>
                            <button onclick="selectAnswer(this, 1, 2)">a) Storing genetic information</button>
                            <button onclick="selectAnswer(this, 0, 2)">b) Producing energy</button>
                            <button onclick="selectAnswer(this, 0, 2)">c) Producing oxygen</button>
                            <button onclick="selectAnswer(this, 0, 2)">d) Transporting nutrients</button>
                        </div>
                        
                        <div class="question">
                            <h2>4. What is the role of ribosomes in a cell?</h2>
                            <button onclick="selectAnswer(this, 1, 3)">a) Protein synthesis</button>
                            <button onclick="selectAnswer(this, 0, 3)">b) DNA replication</button>
                            <button onclick="selectAnswer(this, 0, 3)">c) Cell division</button>
                            <button onclick="selectAnswer(this, 0, 3)">d) Waste processing</button>
                        </div>
                        
                        <div class="question">
                            <h2>5. Which element is essential for the process of respiration in humans?</h2>
                            <button onclick="selectAnswer(this, 0, 4)">a) Nitrogen</button>
                            <button onclick="selectAnswer(this, 1, 4)">b) Oxygen</button>
                            <button onclick="selectAnswer(this, 0, 4)">c) Carbon dioxide</button>
                            <button onclick="selectAnswer(this, 0, 4)">d) Hydrogen</button>
                        </div>
                        
                        <div class="question">
                            <h2>6. Which part of the brain is responsible for regulating basic life functions like heart rate and breathing?</h2>
                            <button onclick="selectAnswer(this, 1, 5)">a) Brainstem</button>
                            <button onclick="selectAnswer(this, 0, 5)">b) Cerebellum</button>
                            <button onclick="selectAnswer(this, 0, 5)">c) Hippocampus</button>
                            <button onclick="selectAnswer(this, 0, 5)">d) Cortex</button>
                        </div>
                        
                        <div class="question">
                            <h2>7. What is the process of meiosis responsible for?</h2>
                            <button onclick="selectAnswer(this, 1, 6)">a) Producing reproductive cells</button>
                            <button onclick="selectAnswer(this, 0, 6)">b) Producing muscle cells</button>
                            <button onclick="selectAnswer(this, 0, 6)">c) Repairing damaged tissues</button>
                            <button onclick="selectAnswer(this, 0, 6)">d) Producing red blood cells</button>
                        </div>
                        
                        <div class="question">
                            <h2>8. What is the main component of the cell membrane?</h2>
                            <button onclick="selectAnswer(this, 1, 7)">a) Phospholipids</button>
                            <button onclick="selectAnswer(this, 0, 7)">b) Proteins</button>
                            <button onclick="selectAnswer(this, 0, 7)">c) Carbohydrates</button>
                            <button onclick="selectAnswer(this, 0, 7)">d) Nucleic acids</button>
                        </div>
                        
                        <div class="question">
                            <h2>9. What type of bond holds two strands of DNA together?</h2>
                            <button onclick="selectAnswer(this, 0, 8)">a) Ionic bond</button>
                            <button onclick="selectAnswer(this, 0, 8)">b) Covalent bond</button>
                            <button onclick="selectAnswer(this, 1, 8)">c) Hydrogen bond</button>
                            <button onclick="selectAnswer(this, 0, 8)">d) Metallic bond</button>
                        </div>
                        
                        <div class="question">
                            <h2>10. What is the primary function of white blood cells?</h2>
                            <button onclick="selectAnswer(this, 1, 9)">a) Fighting infections</button>
                            <button onclick="selectAnswer(this, 0, 9)">b) Carrying oxygen</button>
                            <button onclick="selectAnswer(this, 0, 9)">c) Clotting blood</button>
                            <button onclick="selectAnswer(this, 0, 9)">d) Regulating blood pressure</button>
                        </div>
