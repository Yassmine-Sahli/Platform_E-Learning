...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / languages / Arabic</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/arabic.pdf"
                    ...
                    <iframe 
                            src="https://www.youtube.com/embed/12IwoCwgWH0"
                            frameborder="0"
                    ...
                    <div class="container">
                        <h1>Discover Your Ability in Arabic</h1>
                        <div class="instructions">
                            Instructions: Answer each question, adding up your points as you go. At the end, your total score will help indicate how strong your Arabic fundamentals are.
                        </div>
                    
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What is the first letter of the Arabic alphabet?</h2>
                                <button onclick="selectAnswer(this, 1, 0)">a) أ </button>
                                <button onclick="selectAnswer(this, 0, 0)">b) ب </button>
                                <button onclick="selectAnswer(this, 0, 0)">c) ت </button>
                                <button onclick="selectAnswer(this, 0, 0)">d) ث </button>
                            </div>

                            <div class="question">
                                <h2>2. How many letters are there in the Arabic alphabet?</h2>
                                <button onclick="selectAnswer(this, 0, 1)">a) 26</button>
                                <button onclick="selectAnswer(this, 1, 1)">b) 28</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) 30</button>
                                <button onclick="selectAnswer(this, 0, 1)">d) 24</button>
                            </div>

                            <div class="question">
                                <h2>3. In which direction is Arabic text written?</h2>
                                <button onclick="selectAnswer(this, 1, 2)">a) Right to left</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) Left to right</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) Top to bottom</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) Bottom to top</button>
                            </div>

                            <div class="question">
                                <h2>4. What are the small diacritical marks that indicate short vowels called?</h2>
                                <button onclick="selectAnswer(this, 1, 3)">a) Harakat</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) Tanween</button>
                                <button onclick="selectAnswer(this, 0, 3)">c) Sukun</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) Shadda</button>
                            </div>

                            <div class="question">
                                <h2>5. Which word means "peace" in Arabic?</h2>
                                <button onclick="selectAnswer(this, 1, 4)">a) سَلَام </button>
                                <button onclick="selectAnswer(this, 0, 4)">b) حَبِيبِي </button>
                                <button onclick="selectAnswer(this, 0, 4)">c) شُكْرًا</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) مَرْحَبًا</button>
                            </div>

                            <div class="question">
                                <h2>6. What is the Arabic word for "teacher" (male)?</h2>
                                <button onclick="selectAnswer(this, 0, 5)">a) معلم </button>
                                <button onclick="selectAnswer(this, 1, 5)">b) أستاذ </button>
                                <button onclick="selectAnswer(this, 0, 5)">c) طبيب </button>
                                <button onclick="selectAnswer(this, 0, 5)">d) مهندس </button>
                            </div>

                            <div class="question">
                                <h2>7. What is the Arabic word for "Hello"?</h2>
                                <button onclick="selectAnswer(this, 1, 6)">a) سلام</button>
                                <button onclick="selectAnswer(this, 0, 6)">b) شكرًا</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) مرْحبا</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) صباح الخير</button>
                            </div>

                            <div class="question">
                                <h2>8. What is the Arabic word for "book"?</h2>
                                <button onclick="selectAnswer(this, 1, 7)">a) كتاب </button>
                                <button onclick="selectAnswer(this, 0, 7)">b) مكتبة </button>
                                <button onclick="selectAnswer(this, 0, 7)">c) جزيرة </button>
                                <button onclick="selectAnswer(this, 0, 7)">d) بيت</button>
                            </div>

                            <div class="question">
                                <h2>9. Which numeral system is used in most Arabic-speaking countries?</h2>
                                <button onclick="selectAnswer(this, 1, 8)">a) Eastern Arabic numerals (٠‎–٩)</button>
                                <button onclick="selectAnswer(this, 0, 8)">b) Western Arabic numerals (0–9)</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) Roman numerals (I, V, X…)</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) Chinese numerals</button>
                            </div>

                            <div class="question">
                                <h2>10. What is the Arabic phrase for "thank you"?</h2>
                                <button onclick="selectAnswer(this, 1, 9)">a) شُكْرًا </button>
                                <button onclick="selectAnswer(this, 0, 9)">b) عَفْوًا </button>
                                <button onclick="selectAnswer(this, 0, 9)">c) مَرْحَبًا </button>
                                <button onclick="selectAnswer(this, 0, 9)">d) لا شُكْرًا </button>
                            </div>
                        </div>
                    </div>
                    </div>
