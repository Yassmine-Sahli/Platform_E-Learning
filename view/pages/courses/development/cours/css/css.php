...
<body>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Development / Css</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="document" role="tabpanel" aria-labelledby="document-tab">
                        <iframe
                            src="/tektn/view/assets/pdf/css.pdf"
                    ...
                    <div class="container">
                        <h1>Discover Your ability in CSS</h1>
                        <div class="instructions">
                        Instructions: Answer each question, keeping track of your points as you go. At the end, your total score will indicate your level of advancement.        
                        </div>
                    
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What does CSS stand for?</h2>
                                <button onclick="selectAnswer(this,0 , 0)">a) Colorful Style Sheets</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Creative Styling System</button>
                                <button onclick="selectAnswer(this, 1, 0)">c)  Cascading Style Sheets</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Computer Style Structure</button>
                            </div>
                            <div class="question">
                                <h2>2. Which HTML tag is used to link an external CSS file?                </h2>
                                <button onclick="selectAnswer(this, 0, 1)">a)   &lt;script&gt; </button>
                                <button onclick="selectAnswer(this, 0, 1)">b)&lt;style&gt;</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) &lt;css&gt; </button>
                                <button onclick="selectAnswer(this, 1, 1)">d) &lt;link&gt;</button>
                            </div>
                            <div class="question">
                                <h2>3. Where in an HTML document is the correct place to refer to an external CSS file?</h2>
                                <button onclick="selectAnswer(this, 0, 2)">a) At the bottom of the page</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) Inside the &lt;body&gt; tag</button>
                                <button onclick="selectAnswer(this, 1, 2)">c) Inside the &lt;head&gt; tag</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) Inside the &lt;footer&gt; tag</button>
                            </div>
                            <div class="question">
                                <h2>4. Which property is used to change the background color?</h2>
                                <button onclick="selectAnswer(this, 0, 3)">a) bgcolor</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) color </button>
                                <button onclick="selectAnswer(this, 1, 3)">c) background-color</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) ackground-style</button>
                            </div>
                            <div class="question">
                                <h2>5. How do you add a comment in CSS?</h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) // this is a comment</button>
                                <button onclick="selectAnswer(this, 0, 4)">b) # this is a comment</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) &lt;!-- this is a comment --&gt;</button>
                                <button onclick="selectAnswer(this, 1, 4)">d) &lt;/* this is a comment */&gt;</button>
                            </div>
                            <div class="question">
                                <h2>6. Which CSS property is used to change the text color of an element?</h2>
                                <button onclick="selectAnswer(this, 0, 5)">a) font-color</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) text-color</button>
                                <button onclick="selectAnswer(this, 1, 5)">c) color</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) text-style</button>
                            </div>
                            <div class="question">
                                <h2>7. How do you make all &lt;p&gt; elements bold?</h2>
                                <button onclick="selectAnswer(this, 0, 6)">a) p {text-weight: bold;}</button>
                                <button onclick="selectAnswer(this, 0, 6)">b) p {font-style: bold;}</button>
                                <button onclick="selectAnswer(this, 1, 6)">c) p {font-weight: bold;}</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) p {text-decoration: bold;}</button>
                            </div>
                            <div class="question">
                                <h2>8. Which is the correct way to select an element with the id "header"?</h2>
                                <button onclick="selectAnswer(this, 1, 7)">a) #header        </button>
                                <button onclick="selectAnswer(this, 0, 7)">b) .header</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) header</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) *header</button>
                            </div>
                            <div class="question">
                                <h2>9. Which property controls the size of text?</h2>
                                <button onclick="selectAnswer(this, 0, 8)">a)  text-size</button>
                                <button onclick="selectAnswer(this, 0, 8)">b) font-style</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) text</button>
                                <button onclick="selectAnswer(this, 1, 8)">d) font-size</button>
                            </div>
                            <div class="question">
                                <h2>10. How do you center a block element horizontally?</h2>
                                <button onclick="selectAnswer(this, 0, 9)">a) text-align: center;</button>
                                <button onclick="selectAnswer(this, 0, 9)">b) margin: center;</button>
                                <button onclick="selectAnswer(this, 1, 9)">c) margin: 0 auto;</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) padding: center;</button>
                            </div>
                        </div>
