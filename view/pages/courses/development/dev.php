...
<head>
    ...
    <link rel="stylesheet" href="/tektn/view/global/styles/courses.css">
</head>
<body>
    <!-- Navbar -->
    <section>
    ...
    <section>
        ...
        <div class="course-container">
            <ul class="course-list">
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/html/html.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/html.png" alt="HTML Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">HTML</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/css/css.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/css.png" alt="CSS Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">CSS</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/javascript/js.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/javascript.png" alt="JavaScript Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">JavaScript</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/python/python.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/python.png" alt="Python Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Python</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/java/java.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/java.png" alt="Java Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Java</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/c++/c++.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/c++.png" alt="C++ Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">C++</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/development/cours/php/php.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/php.png" alt="PHP Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">PHP</span>
                </li>
            </ul>
        </div>
    </section>
