    ...
    <section>
        ...
        <div class="course-container">
            <ul class="course-list">
                <li class="course-item" data-url="/tektn/view/pages/courses/marketing/cours/analyse/analyse.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/analyse.png" alt="Analysis Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Marketing Analysis</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/marketing/cours/brand/brand.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/brand.png" alt="brand Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Brand Marketing</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/marketing/cours/digital/digital.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/digital.png" alt="digital Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Digital Marketing</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/marketing/cours/performance/perf.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/performance.png" alt="performance Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Marketing Performance</span>
                </li>
            </ul>
        </div>
    </section>
