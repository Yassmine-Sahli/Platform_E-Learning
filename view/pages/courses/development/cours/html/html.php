...
<body>
 ...
 <section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Development / HTML</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="document" role="tabpanel" aria-labelledby="document-tab">
                            <iframe
                            src="/tektn/view/assets/pdf/html.pdf"
                    ...
                    <div style="max-width: 1000px; margin: 2rem auto; position: relative; overflow: hidden; border-radius: 12px; ">
                        <iframe 
                    ...
                    <div class="container">
                        <h1>Discover Your ability in Html</h1>
                        <div class="instructions">
                        Instructions: Answer each question, keeping track of your points as you go. At the end, your total score will indicate your level of advancement.                        <div id="quiz">
                            <div class="question">
                                <h2>1. What does HTML stand for?</h2>
                                <button onclick="selectAnswer(this,0 , 0)">a) Hyperlinks and Text Markup Language</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Home Tool Markup Language</button>
                                <button onclick="selectAnswer(this, 1, 0)">c) Hyper Text Markup Language</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) High Tech Machine Learning</button>
                            </div>
                            <div class="question">
                                <h2>2. Which tag is used to create a hyperlink in HTML?</h2>
                                <button onclick="selectAnswer(this, 0, 1)">a) &lt;link&gt; </button>
                                <button onclick="selectAnswer(this, 1, 1)">b) &lt;a&gt;</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) &lt;href&gt; </button>
                                <button onclick="selectAnswer(this, 0, 1)">d) &lt;url&gt;</button>
                            </div>
                            <div class="question">
                                <h2>3. Which of the following is the correct HTML for creating a line break?</h2>
                                <button onclick="selectAnswer(this, 0, 2)">a) &lt;break&gt;</button>
                                <button onclick="selectAnswer(this, 1, 2)">b) &lt;br&gt;</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) &lt;lb&gt;</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) &lt;line&gt;</button>
                            </div>
                            <div class="question">
                                <h2>4. Where should the &lt;title&gt; tag be placed?</h2>
                                <button onclick="selectAnswer(this, 0, 3)">a) after the &lt;body&gt;</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) Anywhere in the document </button>
                                <button onclick="selectAnswer(this, 0, 3)">c) Insisde the &lt;footer&gt;</button>
                                <button onclick="selectAnswer(this, 1, 3)">d) inside the &lt;head&gt;</button>
                            </div>
                            <div class="question">
                                <h2>5. What is the correct HTML element for inserting an image?</h2>
                                <button onclick="selectAnswer(this, 1, 4)">a) &lt;img&gt;</button>
                                <button onclick="selectAnswer(this, 0, 4)">b) &lt;image&gt;</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) &lt;pic&gt;</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) &lt;src&gt;</button>
                            </div>
                            <div class="question">
                                <h2>6. How do you write a comment in HTML?</h2>
                                <button onclick="selectAnswer(this, 0, 5)">a) # This is a comment</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) // This is a comment</button>
                                <button onclick="selectAnswer(this, 1, 5)">c) &lt;!-- This is a comment --&gt;</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) ** This is a comment **</button>
                            </div>
                            <div class="question">
                                <h2>7. Which tag creates an unordered list?</h2>
                                <button onclick="selectAnswer(this, 0, 6)">a) &lt;ol&gt;</button>
                                <button onclick="selectAnswer(this, 1, 6)">b) &lt;ul&gt;</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) &lt;li&gt;</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) &lt;list&gt;</button>
                            </div>
                            <div class="question">
                                <h2>8. What does the alt attribute in &lt;img&gt; tag do?</h2>
                                <button onclick="selectAnswer(this, 0, 7)">a) Sets the image size                </button>
                                <button onclick="selectAnswer(this, 0, 7)">b) Displays the image in an alternate format</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) Adds animation</button>
                                <button onclick="selectAnswer(this, 1, 7)">d) Specifies alternative text if the image doesn't load</button>
                            </div>
                            <div class="question">
                                <h2>9. Which input type is used for passwords?</h2>
                                <button onclick="selectAnswer(this, 0, 8)">a)  &lt;input type="text"&gt;</button>
                                <button onclick="selectAnswer(this, 1, 8)">b) &lt;input type="password"&gt;</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) &lt;input type="secure"&gt;</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) &lt;input type="key"&gt;</button>
                            </div>
                            <div class="question">
                                <h2>10. What is the purpose of the &lt;div&gt; element?</h2>
                                <button onclick="selectAnswer(this, 0, 9)">a) To define a table</button>
                                <button onclick="selectAnswer(this, 0, 9)">b) To create an inline element</button>
                                <button onclick="selectAnswer(this, 1, 9)">c) To group block-level content together</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) To make text bold</button>
                            </div>
                        </div>
