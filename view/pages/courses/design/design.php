...
<body>
    ...
    <div class="course-container">
        <ul class="course-list">
            <li class="course-item" data-url="/tektn/view/pages/courses/design/cours/adobe/adobe.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/adobe.png" alt="adobe Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">Adobe Tools</span>
            </li>
            <li class="course-item" data-url="/tektn/view/pages/courses/design/cours/colors/colors.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/colors.png" alt="Color Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">Color Palette</span>
            </li>
            <li class="course-item" data-url="/tektn/view/pages/courses/design/cours/figma/figma.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/figma.png" alt="figma Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">Figma</span>
            </li>
            <li class="course-item" data-url="/tektn/view/pages/courses/design/cours/sketch/sketch.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/sketch.png" alt="sketch Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">Sketch</span>
            </li>
        </ul>
    </div>
</section>
