...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Design / Sketch</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/sketch.pdf"
                    ...
                    <div class="container">
                        <h1>Discover Your ability in Sketch</h1>
                        <div class="instructions">
                        Instructions: Answer each question. At the end, your total score will help indicate how well you know sketch.
                        </div>
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What is Sketch primarily used for?</h2>
                                <button onclick="selectAnswer(this, 1, 0)">a) UI/UX Design</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Video Animation</button>
                                <button onclick="selectAnswer(this, 0, 0)">c) Photo Editing</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Game Development</button>
                            </div>
                            
                            <div class="question">
                                <h2>2. What is the default file extension for a Sketch file?</h2>
                                <button onclick="selectAnswer(this, 0, 1)">a) .psd</button>
                                <button onclick="selectAnswer(this, 0, 1)">b) .fig</button>
                                <button onclick="selectAnswer(this, 1, 1)">c) .sketch</button>
                                <button onclick="selectAnswer(this, 0, 1)">d) .design</button>
                            </div>
                            
                            <div class="question">
                                <h2>3. Which operating system is Sketch available on?</h2>
                                <button onclick="selectAnswer(this, 1, 2)">a) macOS</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) Windows</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) Linux</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) Android</button>
                            </div>
                            
                            <div class="question">
                                <h2>4. What is a Symbol in Sketch?</h2>
                                <button onclick="selectAnswer(this, 1, 3)">a) A reusable design component</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) A type of font</button>
                                <button onclick="selectAnswer(this, 0, 3)">c) A navigation plugin</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) A vector brush</button>
                            </div>
                            
                            <div class="question">
                                <h2>5. Which feature helps maintain consistent spacing and layout in Sketch?</h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) Symbols</button>
                                <button onclick="selectAnswer(this, 1, 4)">b) Smart Guides</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) Animations</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) Pixel Grid</button>
                            </div>
                            
                            <div class="question">
                                <h2>6. What is the name of the collaborative cloud platform offered by Sketch?</h2>
                                <button onclick="selectAnswer(this, 1, 5)">a) Sketch Cloud</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) Sketch Online</button>
                                <button onclick="selectAnswer(this, 0, 5)">c) Sketch Hub</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) Sketch Share</button>
                            </div>
                            
                            <div class="question">
                                <h2>7. Can you prototype interactions directly in Sketch?</h2>
                                <button onclick="selectAnswer(this, 1, 6)">a) Yes</button>
                                <button onclick="selectAnswer(this, 0, 6)">b) No</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) Only with third-party apps</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) Only in InVision</button>
                            </div>
                            
                            <div class="question">
                                <h2>8. What is an Artboard in Sketch?</h2>
                                <button onclick="selectAnswer(this, 1, 7)">a) A canvas area for designing screens or views</button>
                                <button onclick="selectAnswer(this, 0, 7)">b) A type of animation</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) A vector editing tool</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) A collaboration window</button>
                            </div>
                            
                            <div class="question">
                                <h2>9. Which file format can you export assets to from Sketch?</h2>
                                <button onclick="selectAnswer(this, 0, 8)">a) .avi</button>
                                <button onclick="selectAnswer(this, 0, 8)">b) .docx</button>
                                <button onclick="selectAnswer(this, 1, 8)">c) .png</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) .mp4</button>
                            </div>
                            
                            <div class="question">
                                <h2>10. What is the purpose of Shared Styles in Sketch?</h2>
                                <button onclick="selectAnswer(this, 1, 9)">a) To apply consistent styling across multiple elements</button>
                                <button onclick="selectAnswer(this, 0, 9)">b) To share files online</button>
                                <button onclick="selectAnswer(this, 0, 9)">c) To export to Figma</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) To group symbols</button>
                            </div>
