...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / languages / Spanish</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/esp.pdf"
                    ...
                    <iframe 
                            src="https://www.youtube.com/embed/oFatOXcFPB8"
                            frameborder="0"
                    ...
                    <div class="container">
                        <h1>Discover Your Knowledge of the Spanish Language</h1>
                        <div class="instructions">
                        Instructions: Answer each question. At the end, your total score will help indicate how well you know the Spanish language.
                        </div>
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What is the official language of Spain?</h2>
                                <button onclick="selectAnswer(this, 1, 0)">a) Spanish</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Portuguese</button>
                                <button onclick="selectAnswer(this, 0, 0)">c) French</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Italian</button>
                            </div>
                            
                            <div class="question">
                                <h2>2. What is the Spanish word for "hello"?</h2>
                                <button onclick="selectAnswer(this, 0, 1)">a) Bonjour</button>
                                <button onclick="selectAnswer(this, 1, 1)">b) Hola</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) Ciao</button>
                                <button onclick="selectAnswer(this, 0, 1)">d) Guten Tag</button>
                            </div>
                            
                            <div class="question">
                                <h2>3. Which of these countries speaks Spanish as its primary language?</h2>
                                <button onclick="selectAnswer(this, 1, 2)">a) Argentina</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) Brazil</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) Japan</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) Germany</button>
                            </div>
                            
                            <div class="question">
                                <h2>4. What is the Spanish word for "book"?</h2>
                                <button onclick="selectAnswer(this, 1, 3)">a) Libro</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) Livre</button>
                                <button onclick="selectAnswer(this, 0, 3)">c) Buch</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) Libra</button>
                            </div>
                            
                            <div class="question">
                                <h2>5. Which of these is the correct way to say "thank you" in Spanish?</h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) Merci</button>
                                <button onclick="selectAnswer(this, 1, 4)">b) Gracias</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) Danke</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) Arigato</button>
                            </div>
                            
                            <div class="question">
                                <h2>6. How do you say "goodbye" in Spanish?</h2>
                                <button onclick="selectAnswer(this, 0, 5)">a) Ciao</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) Au revoir</button>
                                <button onclick="selectAnswer(this, 0, 5)">c) Tschüss</button>
                                <button onclick="selectAnswer(this, 1, 5)">d) Adiós</button>
                            </div>
                            
                            <div class="question">
                                <h2>7. What is the Spanish word for "dog"?</h2>
                                <button onclick="selectAnswer(this, 1, 6)">a) Perro</button>
                                <button onclick="selectAnswer(this, 0, 6)">b) Katze</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) Chien</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) Hund</button>
                            </div>
                            
                            <div class="question">
                                <h2>8. What does "¿Cómo estás?" mean in English?</h2>
                                <button onclick="selectAnswer(this, 1, 7)">a) How are you?</button>
                                <button onclick="selectAnswer(this, 0, 7)">b) Where are you?</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) What is your name?</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) What time is it?</button>
                            </div>
                            
                            <div class="question">
                                <h2>9. How do you say "I love you" in Spanish?</h2>
                                <button onclick="selectAnswer(this, 1, 8)">a) Te quiero</button>
                                <button onclick="selectAnswer(this, 0, 8)">b) Ich liebe dich</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) Je t'aime</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) Ti amo</button>
                            </div>
                            
                            <div class="question">
                                <h2>10. What is the correct translation of "I am learning Spanish"?</h2>
                                <button onclick="selectAnswer(this, 0, 9)">a) Je suis en train d'apprendre espagnol</button>
                                <button onclick="selectAnswer(this, 1, 9)">b) Estoy aprendiendo español</button>
                                <button onclick="selectAnswer(this, 0, 9)">c) Ich lerne Spanisch</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) Eu estou aprendendo espanhol</button>
                            </div>
