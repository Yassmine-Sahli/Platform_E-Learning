...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Development / JavaScript</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/js.pdf"
                    ...
                    <div class="container">
                        <h1>Discover Your Ability in JavaScript</h1>
                        ...
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What is JavaScript primarily used for?</h2>
                                <button onclick="selectAnswer(this,0 , 0)">a)  Styling web pages</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Structuring content</button>
                                <button onclick="selectAnswer(this, 1, 0)">c)  Making web pages interactive</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Storing data</button>
                            </div>
                            <div class="question">
                                <h2>2. Which keyword is used to declare a variable in JavaScript?                </h2>
                                <button onclick="selectAnswer(this, 0, 1)">a)   var </button>
                                <button onclick="selectAnswer(this, 0, 1)">b) let</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) const </button>
                                <button onclick="selectAnswer(this, 1, 1)">d) All of the above</button>
                            </div>
                            <div class="question">
                                <h2>3. How do you write a comment in JavaScript?</h2>
                                <button onclick="selectAnswer(this, 0, 2)">a) # This is a comment</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) &lt;!-- This is a comment --&gt; </button>
                                <button onclick="selectAnswer(this, 1, 2)">c) // This is a comment</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) ** This is a comment **</button>
                            </div>
                            <div class="question">
                                <h2>4. What will typeof [] return?</h2>
                                <button onclick="selectAnswer(this, 0, 3)">a) "array"</button>
                                <button onclick="selectAnswer(this, 1, 3)">b) "object" </button>
                                <button onclick="selectAnswer(this, 0, 3)">c) "list"</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) "undefined"</button>
                            </div>
                            <div class="question">
                                <h2>5. How do you define a function in JavaScript?</h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) function = myFunc() {}</button>
                                <button onclick="selectAnswer(this, 1, 4)">b) function myFunc() {}</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) def myFunc() {}</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) create function myFunc()</button>
                            </div>
                            <div class="question">
                                <h2>6. Which operator is used to compare both value and type?</h2>
                                <button onclick="selectAnswer(this, 0, 5)">a) =</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) ==</button>
                                <button onclick="selectAnswer(this, 1, 5)">c) ===</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) !=</button>
                            </div>
                            <div class="question">
                                <h2>7. What is the correct syntax to log something to the console?</h2>
                                <button onclick="selectAnswer(this, 0, 6)">a) console.print("Hello") </button>
                                <button onclick="selectAnswer(this, 0, 6)">b) log.console("Hello")</button>
                                <button onclick="selectAnswer(this, 1, 6)">c) console.log("Hello")</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) print.console("Hello")</button>
                            </div>
                            <div class="question">
                                <h2>8. What will 3 + "2" output in JavaScript?</h2>
                                <button onclick="selectAnswer(this, 0, 7)">a) 5       </button>
                                <button onclick="selectAnswer(this, 0, 7)">b) "5"</button>
                                <button onclick="selectAnswer(this, 1, 7)">c) "32"</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) NaN</button>
                            </div>
                            <div class="question">
                                <h2>9. Which method converts a JSON string into a JavaScript object?</h2>
                                <button onclick="selectAnswer(this, 0, 8)">a)  JSON.toObject()</button>
                                <button onclick="selectAnswer(this, 1, 8)">b) JSON.parse()</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) JSON.stringify()</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) JSON.convert()</button>
                            </div>
                            <div class="question">
                                <h2>10. Which symbol is used for single-line comments in JavaScript?</h2>
                                <button onclick="selectAnswer(this, 0, 9)">a) &lt;!-- --&gt;</button>
                                <button onclick="selectAnswer(this, 1, 9)">b) // </button>
                                <button onclick="selectAnswer(this, 0, 9)">c) /* */</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) ##</button>
                            </div>
                        </div>
