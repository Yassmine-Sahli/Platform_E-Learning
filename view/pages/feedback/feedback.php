...
<body>
            ...
            <ul id="ul">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content" id="drop">
                        ...
                        <a  data-url="/tektn/view/pages/feedback/feedback.php" class="active value lien">
    ...
    <?php if (isset($_SESSION['feedback_message'])): ?>
            <div class="alert alert-success text-center" role="alert">
                <?= $_SESSION['feedback_message']; unset($_SESSION['feedback_message']); ?>
            </div>
    <?php endif; ?>
    ...
    <section class="content">
        <div class="feedback-description">
            <img src="../../assets/images/Feedback.gif" alt="Feedback illustration">
        </div>
        <form action="../../../controller/feedback.php" method="post" class="feedback-form">
            <label>Topic</label>
            <input id="topic" class="feedback-form__topic" name="topic" placeholder="Topic" >

            <label for="txt">Message</label>
            <textarea id="txt" class="feedback-form__message" name="txt" placeholder="Type your message..." required rows="5" maxlength="555" ></textarea>
            <p>Leave a message and we will help!</p>
            <button class="feedback-form__submit" id="button" type="submit">Submit</button>
        </form>
    </section>
