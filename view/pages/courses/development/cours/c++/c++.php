...
<body>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Development / C++</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/c++.pdf"
                    ...
                    <div class="tab-pane fade" id="quiz" role="tabpanel" aria-labelledby="quiz-tab">
                        ...
                        <div class="container">
                            <h1>Discover Your Ability in C++</h1>
                            <div class="instructions">
                            Instructions: Answer each question, keeping track of your points as you go. At the end, your total score will indicate your level of advancement.                            </div>
                        
                            <div id="quiz">
                                <div class="question">
                                    <h2>1. What is the extension of a C++ source file?</h2>
                                    <button onclick="selectAnswer(this,0 , 0)">a) .cp</button>
                                    <button onclick="selectAnswer(this, 0, 0)">b) .cpl</button>
                                    <button onclick="selectAnswer(this, 1, 0)">c) .cpp</button>
                                    <button onclick="selectAnswer(this, 0, 0)">d) .ccp</button>
                                </div>
                                <div class="question">
                                    <h2>2. Which of the following is used to define a constant in C++?</h2>
                                    <button onclick="selectAnswer(this, 0, 1)">a) constant</button>
                                    <button onclick="selectAnswer(this, 1, 1)">b) const</button>
                                    <button onclick="selectAnswer(this, 0, 1)">c) #value</button>
                                    <button onclick="selectAnswer(this, 0, 1)">d) define_const</button>
                                </div>
                                <div class="question">
                                    <h2>3. Which operator is used to allocate memory dynamically?</h2>
                                    <button onclick="selectAnswer(this, 0, 2)">a) malloc</button>
                                    <button onclick="selectAnswer(this, 0, 2)">b) alloc</button>
                                    <button onclick="selectAnswer(this, 1, 2)">c) new</button>
                                    <button onclick="selectAnswer(this, 0, 2)">d) allocate</button>
                                </div>
                                <div class="question">
                                    <h2>4. What does `std` stand for in C++?</h2>
                                    <button onclick="selectAnswer(this, 1, 3)">a) Standard</button>
                                    <button onclick="selectAnswer(this, 0, 3)">b) Structure Type Definition</button>
                                    <button onclick="selectAnswer(this, 0, 3)">c) Start Type Directive</button>
                                    <button onclick="selectAnswer(this, 0, 3)">d) Standardized Template</button>
                                </div>
                                <div class="question">
                                    <h2>5. Which header file is needed to use `cout`?</h2>
                                    <button onclick="selectAnswer(this, 1, 4)">a) &lt;iostream&gt;</button>
                                    <button onclick="selectAnswer(this, 0, 4)">b) &lt;stdio.h&gt;</button>
                                    <button onclick="selectAnswer(this, 0, 4)">c) &lt;stream.h&gt;</button>
                                    <button onclick="selectAnswer(this, 0, 4)">d) &lt;console.h&gt;</button>
                                </div>
                                <div class="question">
                                    <h2>6. How do you comment a single line in C++?</h2>
                                    <button onclick="selectAnswer(this, 1, 5)">a) // comment</button>
                                    <button onclick="selectAnswer(this, 0, 5)">b) \* comment \*</button>
                                    <button onclick="selectAnswer(this, 0, 5)">c) # comment</button>
                                    <button onclick="selectAnswer(this, 0, 5)">d) <!-- comment --></button>
                                </div>
                                <div class="question">
                                    <h2>7. What is the output of: <code>cout &lt;&lt; 5/2;</code>?</h2>
                                    <button onclick="selectAnswer(this, 1, 6)">a) 2</button>
                                    <button onclick="selectAnswer(this, 0, 6)">b) 2.5</button>
                                    <button onclick="selectAnswer(this, 0, 6)">c) 2.0</button>
                                    <button onclick="selectAnswer(this, 0, 6)">d) Error</button>
                                </div>
                                <div class="question">
                                    <h2>8. Which concept allows the same function name with different parameters?</h2>
                                    <button onclick="selectAnswer(this, 1, 7)">a) Function Overloading</button>
                                    <button onclick="selectAnswer(this, 0, 7)">b) Encapsulation</button>
                                    <button onclick="selectAnswer(this, 0, 7)">c) Inheritance</button>
                                    <button onclick="selectAnswer(this, 0, 7)">d) Polymorphism</button>
                                </div>
                                <div class="question">
                                    <h2>9. What is the default access specifier for class members in C++?</h2>
                                    <button onclick="selectAnswer(this, 0, 8)">a) public</button>
                                    <button onclick="selectAnswer(this, 0, 8)">b) protected</button>
                                    <button onclick="selectAnswer(this, 1, 8)">c) private</button>
                                    <button onclick="selectAnswer(this, 0, 8)">d) external</button>
                                </div>
                                <div class="question">
                                    <h2>10. Which of the following is used for input in C++?</h2>
                                    <button onclick="selectAnswer(this, 1, 9)">a) cin</button>
                                    <button onclick="selectAnswer(this, 0, 9)">b) cout</button>
                                    <button onclick="selectAnswer(this, 0, 9)">c) input()</button>
                                    <button onclick="selectAnswer(this, 0, 9)">d) read()</button>
                                </div>
                            </div>
