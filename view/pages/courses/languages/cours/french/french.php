...
<section>
     ...
     <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / languages / French</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/french.pdf"
                    ...
                    <iframe 
                            src="https://www.youtube.com/embed/RxCR3g6aYJ0"
                            frameborder="0"
                    ...
                    <div class="container">
                        <h1>Discover Your Ability in French</h1>
                        <div class="instructions">
                            Instructions: Answer each question, adding up your points as you go. At the end, your total score will help indicate how strong your fundamentals are in French.
                        </div>

                        <div id="quiz-french">
                            <div class="question">
                                <h2>1. Quel temps utilise-t-on pour parler d’une action achevée dans le passé, antérieure à un autre fait passé ?</h2>
                                <button onclick="selectAnswer(this, 0, 0)">a) Imparfait</button>
                                <button onclick="selectAnswer(this, 1, 0)">b) Plus-que-parfait</button>
                                <button onclick="selectAnswer(this, 0, 0)">c) Passé composé</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Futur antérieur</button>
                            </div>

                            <div class="question">
                                <h2>2. Dans la phrase “Il faut que tu viennes”, quel mode est employé ?</h2>
                                <button onclick="selectAnswer(this, 1, 1)">a) Subjonctif</button>
                                <button onclick="selectAnswer(this, 0, 1)">b) Indicatif</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) Conditionnel</button>
                                <button onclick="selectAnswer(this, 0, 1)">d) Impératif</button>
                            </div>

                            <div class="question">
                                <h2>3. Quel pronom remplace “à Marie” dans “Je parle à Marie” ?</h2>
                                <button onclick="selectAnswer(this, 0, 2)">a) Elle</button>
                                <button onclick="selectAnswer(this, 1, 2)">b) Lui</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) La</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) Le</button>
                            </div>

                            <div class="question">
                                <h2>4. Lequel de ces mots est un participe passé irrégulier ?</h2>
                                <button onclick="selectAnswer(this, 1, 3)">a) Réçu</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) Aimé</button>
                                <button onclick="selectAnswer(this, 0, 3)">c) FinI</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) Parlé</button>
                            </div>

                            <div class="question">
                                <h2>5. Quelle est la forme correcte du “on” impersonnel pour “nous aurons vu”? </h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) On avons vu</button>
                                <button onclick="selectAnswer(this, 1, 4)">b) On aura vu</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) On avons avoir vu</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) On aurait vu</button>
                            </div>

                            <div class="question">
                                <h2>6. Dans “Il s’est couché tard”, quel est l’auxiliaire et pourquoi ?</h2>
                                <button onclick="selectAnswer(this, 1, 5)">a) Être, car le verbe est pronominal</button>
                                <button onclick="selectAnswer(this, 0, 5)">b) Avoir, car c’est un verbe d’état</button>
                                <button onclick="selectAnswer(this, 0, 5)">c) Avoir, car c’est transitif</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) Être, car c’est intransitif</button>
                            </div>

                            <div class="question">
                                <h2>7. Quel mot est un adverbe de quantité ?</h2>
                                <button onclick="selectAnswer(this, 0, 6)">a) Lentement</button>
                                <button onclick="selectAnswer(this, 1, 6)">b) Peu</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) Partout</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) Hier</button>
                            </div>

                            <div class="question">
                                <h2>8. Lequel de ces accords est correct ?</h2>
                                <button onclick="selectAnswer(this, 0, 7)">a) Des pommes est jolies</button>
                                <button onclick="selectAnswer(this, 1, 7)">b) Les pommes sont jolies</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) Les pommes est jolies</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) Des pommes sont joli</button>
                            </div>

                            <div class="question">
                                <h2>9. Quel mot ajoute un sens intensif à l’adjectif ?</h2>
                                <button onclick="selectAnswer(this, 1, 8)">a) Très</button>
                                <button onclick="selectAnswer(this, 0, 8)">b) Mais</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) Donc</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) Car</button>
                            </div>

                            <div class="question">
                                <h2>10. Quelle expression signifie “to pull someone’s leg” ?</h2>
                                <button onclick="selectAnswer(this, 0, 9)">a) Mettre la main à la pâte</button>
                                <button onclick="selectAnswer(this, 1, 9)">b) Tirer quelqu’un par la jambe</button>
                                <button onclick="selectAnswer(this, 0, 9)">c) Avoir la jambe légère</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) Faire un pied de nez</button>
                            </div>
                        </div>
                    </div>
