    ...
    <section>
        ...
        <div class="course-container">
            <ul class="course-list">
                <li class="course-item" data-url="/tektn/view/pages/courses/languages/cours/arabic/arabic.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/arabic.png" alt="arabic Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Arabic</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/languages/cours/english/english.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/english.png" alt="english Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">English</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/languages/cours/french/french.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/french.png" alt="French Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">French</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/languages/cours/spanish/spanish.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/spanish.png" alt="Spanish Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                    <span class="course-name">Spanish</span>
                </li>
            </ul>
        </div>
    </section>
