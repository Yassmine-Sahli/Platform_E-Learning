    ...
    <section>
        ...
        <div class="course-container">
            <ul class="course-list">
                <li class="course-item" data-url="/tektn/view/pages/courses/islamic/course/quran/quran.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/quran.png" alt="Quran Icon" style="max-width:4em; max-height:4em; display:block; margin:0 auto;">
                    <span class="course-name">Quran</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/islamic/course/prayer/prayer.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/prayer.png" alt="Prayer Time Icon" style="max-width:4em; max-height:4em; display:block; margin:0 auto;">
                    <span class="course-name">Prayer time</span>
                </li>
                <li class="course-item" data-url="/tektn/view/pages/courses/islamic/course/calender/calender.php" onclick="window.location.href=this.dataset.url">
                    <img src="/tektn/view/assets/icons/calender.png" alt="calender Icon" style="max-width:4em; max-height:4em; display:block; margin:0 auto;">
                    <span class="course-name">Islamic Calender</span>
                </li>
            </ul>
        </div>
    </section>
