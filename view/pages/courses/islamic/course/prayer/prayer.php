...
<head>
    ...
    <script src="./prayer.js" defer></script>
    ...
    <link rel="stylesheet" href="../../../../../global/styles/courses.css">
    ...
    <section class="prayer-section">
        <div class="container">
            ...
            <div class="recherche">
                ...
                <button id="recherche-btn">Search</button>
            </div>
            <p id="status"></p>
            <ul id="prayer-times" class="prayer-times"></ul>
        </div>
    </section>
