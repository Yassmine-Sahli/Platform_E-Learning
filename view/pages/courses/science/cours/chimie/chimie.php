...
<!-- Navbar -->
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Science / Chemistry</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/chimie.pdf"
                    ...
                    <iframe 
                            src="https://www.youtube.com/embed/5iTOphGnCtg"
                            frameborder="0"
                    ...
                    <div class="container">
                    <h1>Discover Your Chemistry Knowledge</h1>
                    <div class="instructions">
                    Instructions: Answer each question. At the end, your total score will help indicate your chemistry knowledge.
                    </div>
                    <div id="quiz">
                        <div class="question">
                            <h2>1. What is the atomic number of Hydrogen?</h2>
                            <button onclick="selectAnswer(this, 1, 0)">a) 1</button>
                            <button onclick="selectAnswer(this, 0, 0)">b) 2</button>
                            <button onclick="selectAnswer(this, 0, 0)">c) 3</button>
                            <button onclick="selectAnswer(this, 0, 0)">d) 4</button>
                        </div>
                        
                        <div class="question">
                            <h2>2. What is the chemical formula for water?</h2>
                            <button onclick="selectAnswer(this, 0, 1)">a) H2O2</button>
                            <button onclick="selectAnswer(this, 1, 1)">b) H2O</button>
                            <button onclick="selectAnswer(this, 0, 1)">c) H2</button>
                            <button onclick="selectAnswer(this, 0, 1)">d) O2</button>
                        </div>
                        
                        <div class="question">
                            <h2>3. What is the pH value of pure water?</h2>
                            <button onclick="selectAnswer(this, 1, 2)">a) 7</button>
                            <button onclick="selectAnswer(this, 0, 2)">b) 5</button>
                            <button onclick="selectAnswer(this, 0, 2)">c) 10</button>
                            <button onclick="selectAnswer(this, 0, 2)">d) 14</button>
                        </div>
                        
                        <div class="question">
                            <h2>4. What is the most common element in the Earth's crust?</h2>
                            <button onclick="selectAnswer(this, 1, 3)">a) Oxygen</button>
                            <button onclick="selectAnswer(this, 0, 3)">b) Silicon</button>
                            <button onclick="selectAnswer(this, 0, 3)">c) Carbon</button>
                            <button onclick="selectAnswer(this, 0, 3)">d) Iron</button>
                        </div>
                        
                        <div class="question">
                            <h2>5. What type of bond is formed between two nonmetals?</h2>
                            <button onclick="selectAnswer(this, 0, 4)">a) Ionic Bond</button>
                            <button onclick="selectAnswer(this, 1, 4)">b) Covalent Bond</button>
                            <button onclick="selectAnswer(this, 0, 4)">c) Metallic Bond</button>
                            <button onclick="selectAnswer(this, 0, 4)">d) Hydrogen Bond</button>
                        </div>
                        
                        <div class="question">
                            <h2>6. What is the atomic mass of Carbon?</h2>
                            <button onclick="selectAnswer(this, 1, 5)">a) 12</button>
                            <button onclick="selectAnswer(this, 0, 5)">b) 16</button>
                            <button onclick="selectAnswer(this, 0, 5)">c) 14</button>
                            <button onclick="selectAnswer(this, 0, 5)">d) 18</button>
                        </div>
                        
                        <div class="question">
                            <h2>7. What is the process of a solid turning into a liquid called?</h2>
                            <button onclick="selectAnswer(this, 1, 6)">a) Melting</button>
                            <button onclick="selectAnswer(this, 0, 6)">b) Freezing</button>
                            <button onclick="selectAnswer(this, 0, 6)">c) Condensation</button>
                            <button onclick="selectAnswer(this, 0, 6)">d) Sublimation</button>
                        </div>
                        
                        <div class="question">
                            <h2>8. What is the unit for measuring the amount of substance?</h2>
                            <button onclick="selectAnswer(this, 1, 7)">a) Mole</button>
                            <button onclick="selectAnswer(this, 0, 7)">b) Liter</button>
                            <button onclick="selectAnswer(this, 0, 7)">c) Gram</button>
                            <button onclick="selectAnswer(this, 0, 7)">d) Newton</button>
                        </div>
                        
                        <div class="question">
                            <h2>9. Which of these is a noble gas?</h2>
                            <button onclick="selectAnswer(this, 0, 8)">a) Oxygen</button>
                            <button onclick="selectAnswer(this, 0, 8)">b) Nitrogen</button>
                            <button onclick="selectAnswer(this, 1, 8)">c) Helium</button>
                            <button onclick="selectAnswer(this, 0, 8)">d) Hydrogen</button>
                        </div>
                        
                        <div class="question">
                            <h2>10. What is the chemical symbol for Gold?</h2>
                            <button onclick="selectAnswer(this, 1, 9)">a) Au</button>
                            <button onclick="selectAnswer(this, 0, 9)">b) Ag</button>
                            <button onclick="selectAnswer(this, 0, 9)">c) Pb</button>
                            <button onclick="selectAnswer(this, 0, 9)">d) Fe</button>
                        </div>
