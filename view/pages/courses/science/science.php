...
<body>
    ...
    <div class="course-container">
        <ul class="course-list">
            <li class="course-item" data-url="/tektn/view/pages/courses/science/cours/math/math.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/math.png" alt="math Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">math</span>
            </li>
            <li class="course-item" data-url="/tektn/view/pages/courses/science/cours/svt/svt.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/svt.png" alt="svt Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">Science</span>
            </li>
            <li class="course-item" data-url="/tektn/view/pages/courses/science/cours/physique/phy.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/physique.png" alt="physique Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
                <span class="course-name">Physics</span>
            </li>
            <li class="course-item" data-url="/tektn/view/pages/courses/science/cours/chimie/chimie.php" onclick="window.location.href=this.dataset.url">
                <img src="/tektn/view/assets/icons/chimie.png" alt="chimie Icon" style="max-width:2em; max-height:2em; display:block; margin:0 auto;">
