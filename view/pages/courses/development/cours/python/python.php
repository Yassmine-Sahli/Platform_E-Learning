...
<section>
   ...
   <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Development / Python</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="document" role="tabpanel" aria-labelledby="document-tab">
                        <iframe
                            src="/tektn/view/assets/pdf/python.pdf"
                    ...
                    <div class="container">
                        <h1>Discover Your Ability in Python</h1>
                        <div class="instructions">
                        Instructions: Answer each question, adding up your points as you go. At the end, your total score will help indicate your advancement .
                        </div>
                    
                        <div id="quiz">
                            <div class="question">
                                <h2>1. What is Python mainly used for?</h2>
                                <button onclick="selectAnswer(this,0 , 0)">a) Designing web pages</button>
                                <button onclick="selectAnswer(this, 0, 0)">b) Writing CSS styles</button>
                                <button onclick="selectAnswer(this, 1, 0)">c) Programming and automation</button>
                                <button onclick="selectAnswer(this, 0, 0)">d) Creating animations</button>
                            </div>
                            <div class="question">
                                <h2>2. How do you declare a variable in Python?</h2>
                                <button onclick="selectAnswer(this, 1, 1)">a) x = 5</button>
                                <button onclick="selectAnswer(this, 0, 1)">b) var x = 5</button>
                                <button onclick="selectAnswer(this, 0, 1)">c) let x = 5</button>
                                <button onclick="selectAnswer(this, 0, 1)">d) int x = 5</button>
                            </div>
                            <div class="question">
                                <h2>3. How do you write a comment in Python?</h2>
                                <button onclick="selectAnswer(this, 1, 2)">a) # This is a comment</button>
                                <button onclick="selectAnswer(this, 0, 2)">b) // This is a comment</button>
                                <button onclick="selectAnswer(this, 0, 2)">c) &lt;!-- This is a comment --&gt;</button>
                                <button onclick="selectAnswer(this, 0, 2)">d) ** This is a comment **</button>
                            </div>
                            <div class="question">
                                <h2>4. Which of the following is a list in Python?</h2>
                                <button onclick="selectAnswer(this, 1, 3)">a) [1, 2, 3]</button>
                                <button onclick="selectAnswer(this, 0, 3)">b) {1, 2, 3}</button>
                                <button onclick="selectAnswer(this, 0, 3)">c) (1, 2, 3)</button>
                                <button onclick="selectAnswer(this, 0, 3)">d) <1, 2, 3></button>
                            </div>
                            <div class="question">
                                <h2>5. How do you define a function in Python?</h2>
                                <button onclick="selectAnswer(this, 0, 4)">a) function myFunc() {}</button>
                                <button onclick="selectAnswer(this, 1, 4)">b) def myFunc():</button>
                                <button onclick="selectAnswer(this, 0, 4)">c) func myFunc()</button>
                                <button onclick="selectAnswer(this, 0, 4)">d) define myFunc()</button>
                            </div>
                            <div class="question">
                                <h2>6. What is the output of print(type(10))?</h2>
                                <button onclick="selectAnswer(this, 0, 5)">a) &lt;class 'float'&gt;</button>
                                <button onclick="selectAnswer(this, 1, 5)">b) &lt;class 'int'&gt;</button>
                                <button onclick="selectAnswer(this, 0, 5)">c) &lt;type 'int'&gt;</button>
                                <button onclick="selectAnswer(this, 0, 5)">d) integer</button>
                            </div>
                            <div class="question">
                                <h2>7. Which of the following is used to handle exceptions in Python?</h2>
                                <button onclick="selectAnswer(this, 1, 6)">a) try/except</button>
                                <button onclick="selectAnswer(this, 0, 6)">b) do/catch</button>
                                <button onclick="selectAnswer(this, 0, 6)">c) try/catch</button>
                                <button onclick="selectAnswer(this, 0, 6)">d) handle/error</button>
                            </div>
                            <div class="question">
                                <h2>8. What does the `len()` function do?</h2>
                                <button onclick="selectAnswer(this, 0, 7)">a) Returns the type of an object</button>
                                <button onclick="selectAnswer(this, 1, 7)">b) Returns the number of items in a list</button>
                                <button onclick="selectAnswer(this, 0, 7)">c) Creates a new list</button>
                                <button onclick="selectAnswer(this, 0, 7)">d) Sorts a list</button>
                            </div>
                            <div class="question">
                                <h2>9. What is the correct way to open a file in Python?</h2>
                                <button onclick="selectAnswer(this, 0, 8)">a) open.file("data.txt")</button>
                                <button onclick="selectAnswer(this, 1, 8)">b) open("data.txt")</button>
                                <button onclick="selectAnswer(this, 0, 8)">c) file.open("data.txt")</button>
                                <button onclick="selectAnswer(this, 0, 8)">d) file("data.txt")</button>
                            </div>
                            <div class="question">
                                <h2>10. What is the output of: print("Python"[0])?</h2>
                                <button onclick="selectAnswer(this, 1, 9)">a) P</button>
                                <button onclick="selectAnswer(this, 0, 9)">b) y</button>
                                <button onclick="selectAnswer(this, 0, 9)">c) h</button>
                                <button onclick="selectAnswer(this, 0, 9)">d) n</button>
                            </div>
                        </div>
