...
<section>
    ...
    <section id="content">
        <div class="title">
            <h6><i class="fa-solid fa-house-chimney"></i> Course / Development / PHP</h6>
        </div>
        <div class="crd">
            <div class="card text-center">
                ...
                <div class="card-body tab-content" id="myTabContent">
                    ...
                    <iframe
                            src="/tektn/view/assets/pdf/php.pdf"
                    ...
                    <div class="container">
                        <h1>Discover Your ability in PHP</h1>
                        ...
                        <div id="quiz">
                            <div class="question">
                                ...
                                <button onclick="selectAnswer(this,0 , 0)">a) Personal Home Page</button>
                                <button onclick="selectAnswer(this,0 , 0)">b) Private Hypertext Processor</button>
                                <button onclick="selectAnswer(this,1 , 0)">c) PHP: Hypertext Preprocessor</button>
                                <button onclick="selectAnswer(this,0 , 0)">d) Programmed HTML Processor</button>
                            </div>
                            <div class="question">
                                <h2>2. What symbol is used to start a PHP block?</h2>
                                <button onclick="selectAnswer(this,0 , 1)">a) &lt;script&gt;</button>
                                <button onclick="selectAnswer(this,1 , 1)">b) &lt;?php&gt;</button>
                                <button onclick="selectAnswer(this,0 , 1)">c) &lt;php&gt;</button>
                                <button onclick="selectAnswer(this,0 , 1)">d) &lt;%&gt;</button>
                            </div>
                            <div class="question">
                                <h2>3. Which of the following is a correct variable declaration in PHP?</h2>
                                <button onclick="selectAnswer(this,1 , 2)">a) $var = "hello";</button>
                                <button onclick="selectAnswer(this,0 , 2)">b) var $var = "hello";</button>
                                <button onclick="selectAnswer(this,0 , 2)">c) let var = "hello";</button>
                                <button onclick="selectAnswer(this,0 , 2)">d) variable var = "hello";</button>
                            </div>
                            <div class="question">
                                <h2>4. Which function is used to output data in PHP?</h2>
                                <button onclick="selectAnswer(this,1 , 3)">a) echo</button>
                                <button onclick="selectAnswer(this,0 , 3)">b) write</button>
                                <button onclick="selectAnswer(this,0 , 3)">c) log</button>
                                <button onclick="selectAnswer(this,0 , 3)">d) printline</button>
                            </div>
                            <div class="question">
                                <h2>5. What is the correct way to write a comment in PHP?</h2>
                                <button onclick="selectAnswer(this,0 , 4)">a) &lt;!-- comment --&gt;</button>
                                <button onclick="selectAnswer(this,1 , 4)">b) // comment</button>
                                <button onclick="selectAnswer(this,0 , 4)">c) \* comment *</button>
                                <button onclick="selectAnswer(this,0 , 4)">d) #* comment *</button>
                            </div>
                            <div class="question">
                                <h2>6. Which of these is a superglobal in PHP?</h2>
                                <button onclick="selectAnswer(this,1 , 5)">a) $_POST</button>
                                <button onclick="selectAnswer(this,0 , 5)">b) $GLOBAL_POST</button>
                                <button onclick="selectAnswer(this,0 , 5)">c) POST_$</button>
                                <button onclick="selectAnswer(this,0 , 5)">d) globalPost()</button>
                            </div>
                            <div class="question">
                                <h2>7. Which operator is used for concatenation in PHP?</h2>
                                <button onclick="selectAnswer(this,0 , 6)">a) +</button>
                                <button onclick="selectAnswer(this,1 , 6)">b) .</button>
                                <button onclick="selectAnswer(this,0 , 6)">c) &</button>
                                <button onclick="selectAnswer(this,0 , 6)">d) ,</button>
                            </div>
                            <div class="question">
                                <h2>8. How do you get the length of a string in PHP?</h2>
                                <button onclick="selectAnswer(this,0 , 7)">a) length($str)</button>
                                <button onclick="selectAnswer(this,0 , 7)">b) $str.len</button>
                                <button onclick="selectAnswer(this,1 , 7)">c) strlen($str)</button>
                                <button onclick="selectAnswer(this,0 , 7)">d) strlength($str)</button>
                            </div>
                            <div class="question">
                                <h2>9. Which function is used to connect to a MySQL database in PHP (MySQLi)?</h2>
                                <button onclick="selectAnswer(this,0 , 8)">a) connectDB()</button>
                                <button onclick="selectAnswer(this,1 , 8)">b) mysqli_connect()</button>
                                <button onclick="selectAnswer(this,0 , 8)">c) db_connect()</button>
                                <button onclick="selectAnswer(this,0 , 8)">d) openConnection()</button>
                            </div>
                            <div class="question">
                                <h2>10. What will `isset($var)` return if $var is not set?</h2>
                                <button onclick="selectAnswer(this,1 , 9)">a) false</button>
                                <button onclick="selectAnswer(this,0 , 9)">b) true</button>
                                <button onclick="selectAnswer(this,0 , 9)">c) null</button>
                                <button onclick="selectAnswer(this,0 , 9)">d) error</button>
                            </div>
                        </div>
